...
public class ReviewControllerTest {
    ...
    @Test
    public void getReviewsForProduct_ExceptionThrown() throws Exception {
        // Mock data
        String productSN = "123456789123456858";

        // Mock the service behavior to simulate an exception
        when(reviewService.getReviewsForProduct(productSN)).thenThrow(new RuntimeException("Service exception"));
